...
class BaseModel(BaseModel):
    ...
    def optimize_parameters(self):
        ...
        if self.modal_1:
            ...
            # self.fake_1, self.fake_2 = self.netG(self.im1_lr, self.im2_gt, self.mask)
            ...
            # self.fake_2, self.fake_1 = self.netG(self.im2_lr, self.im1_gt, self.mask)
    ...
    def test(self):
        ...
        with torch.no_grad():
            if self.modal_1:
                ...
                # self.fake_H,_ = self.netG(self.im1_lr, self.im2_gt, self.mask)
            else:
                self.fake_H = self.netG(self.im2_lr, self.im1_gt, self.mask)
                # self.fake_H ,_= self.netG(self.im2_lr, self.im1_gt, self.mask)
        self.netG.train()
